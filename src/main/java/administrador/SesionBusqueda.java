...
/**
 * Se crea una nueva instancia antes de comenzar la busqueda. A trav�s de las etapas que atraviece la busqueda, esta instancia debe ser pasada por parametro.
...
public class SesionBusqueda {
	...
	/*
	 * Se modifica m�todo para hacerlo coincidir con el nuevo constructor
...
/*public void finalizarBusqueda(){
	...
	/*
	 * Identico caso al m�todo anterior, se modifica m�todo para pasar
	 * por par�metro la lista de pois encontrados y no la lista de ids
	 */
