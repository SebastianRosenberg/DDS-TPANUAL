...
public class GestorDeUsuarios {
	...
	/**Si alguien intenta loguearse como admin y alguien m�s est� logueado, echa a la persona que ya esta logueada
	 */
	...
	public  Usuario logueoComoAdmin(Usuario admin, String passwordIngresada, Usuario terminalActual)
	{
			...
			{
				System.out.println("contrase�a equivocada, por favor intente nuevamente");
				return null;
			}
	...
	public Usuario buscarUsuarioPorNombre(String nombreUsuario){
		...
		return null;//No se encontró un usuario con ese nombre
	}
}
